...
class PPOBCOnOffPolicyAdapter(OnlineAdapter):
                ...
                if epoch_end or done or time_out:
                    ...
                    if not done:
                        if epoch_end:
                            ...
                            _, last_value_r, last_value_c, last_value_b, _ = agent.step(obs[idx].unsqueeze(0))
                        if time_out:
                            # obz = info['final_observation'][idx]
                            # print(f'obz is {obz}\n of shape {obz.shape}')
                            _, last_value_r, last_value_c, last_value_b, _ = agent.step(
