...
from omnisafe.algorithms import model_based, off_policy, offline, on_policy, my_algorithms
...
# My algorithms
from omnisafe.algorithms.my_algorithms import StaticBinaryCritic
...
ALGORITHMS = {
    ...
    'my_algorithms': tuple(my_algorithms.__all__)
}
